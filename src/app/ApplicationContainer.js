...
import { InMemoryTransactionManager } from "../infrastructure/memory/InMemoryTransactionManager.js";
import { InMemoryJobQueue } from "../infrastructure/memory/InMemoryJobQueue.js";
...
import { InMemoryAuthRepository } from "../modules/auth/repositories/InMemoryAuthRepository.js";
import { InMemoryUserRepository } from "../modules/users/repositories/InMemoryUserRepository.js";
import { InMemoryProductRepository } from "../modules/products/repositories/InMemoryProductRepository.js";
import { InMemoryCustomerRepository } from "../modules/customers/repositories/InMemoryCustomerRepository.js";
import { InMemorySupplierRepository } from "../modules/suppliers/repositories/InMemorySupplierRepository.js";
import { InMemoryInventoryRepository } from "../modules/inventory/repositories/InMemoryInventoryRepository.js";
import { InMemorySaleRepository } from "../modules/sales/repositories/InMemorySaleRepository.js";
import { InMemoryJobRepository } from "../modules/jobs/repositories/InMemoryJobRepository.js";
...
export class ApplicationContainer {
  async init() {
    ...
    if (this.config.isMemory) {
      ...
      this.authRepo = new InMemoryAuthRepository(this.store);
      this.userRepo = new InMemoryUserRepository(this.store);
      this.productRepo = new InMemoryProductRepository(this.store, this.cache);
      this.customerRepo = new InMemoryCustomerRepository(this.store);
      this.supplierRepo = new InMemorySupplierRepository(this.store);
      this.inventoryRepo = new InMemoryInventoryRepository(this.store);
      this.saleRepo = new InMemorySaleRepository(this.store);
      this.jobRepo = new InMemoryJobRepository(this.store);
    } else {
